...
<html>
    ...
    <meta charset="UTF-8">
        ...
        <title>Anime4U-Anime-List</title>
    ...
    <body>
        ...
        <nav style="position: sticky; top: 0; z-index: 5;">
            ...
            <ul class="mynavbar container-fluid">
                ...
                <li style="background-color: #e6b800;"><a style="color: black;" class="title" href="animelist.php">ANIME LIST</a></li>
               ...
               if(!empty($_SESSION['username'])){
                ...
                ?>  
                    ...
                    ?>
                     <div class="content container ">
                    <?php
                        $qry="select * from animelist where type='A'";
                        $res=mysqli_query($conn,$qry);
