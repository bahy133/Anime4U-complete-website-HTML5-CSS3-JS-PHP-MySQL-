    ...
    <body>
        ...
        <section>
            <div class="regForm admin container">
                ...
                <form class="reg adminform" action="inserfile.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" id="trailer" name="trailer" required placeholder="Check Video down below">
                    <br>
                    <br>
                    ...
                    <br>
                    <br>
                    <label for="bgimg">Anime Background<sup>*</sup></label>
                    <input type="file" id="bgimg" name="bgimg" required>
                    <br>
                    <label for="episodes">Anime Episodes<sup>*</sup></label>
                    <input type="number" id="episodes" name="episodes" required min="1">
                    <br>
                    <br>
                    <button type="submit" class="regbtn adminbtn">ADD</button>
                </form>
